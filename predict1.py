...
def generate_explanation_and_plan(symptom):
    ...
    # Neurological
    if any(k in s for k in ["stroke", "paralysis", "weakness", "nerve", "parkinson", "dementia", "brain"]):
        return (
            "The reported symptoms indicate neurological impairment affecting movement, coordination, and daily functioning.",
            [
                "Nursing care: Medication administration and vitals monitoring",
    ...
    # Orthopedic / joint / fracture / replacement
    if any(k in s for k in ["fracture", "bone", "knee", "hip", "joint", "back", "pain", "replacement"]):
        return (
            "Symptoms suggest an orthopedic or musculoskeletal condition requiring rehabilitation.",
            [
                "Pain management nursing care",
    ...
    # Wound / dressing / infection
    if any(k in s for k in ["surgery", "post", "wound", "dressing", "stitch", "infection", "ulcer"]):
        return (
            "Patient requires post-surgical or wound care and monitoring.",
            [
    ...
    if any(k in s for k in ["breathing", "oxygen", "lungs", "copd", "asthma", "respiratory"]):
        return (
            "Symptoms indicate respiratory support or oxygen monitoring is required.",
            [
                "Monitor oxygen levels",
                "Use respiratory equipment as needed",
                "Medication and nursing assistance",
                "Ensure patient comfort during breathing",
                "Observe for emergency symptoms"
            ]
        )

    # Cardiac
    if any(k in s for k in ["heart", "cardiac", "bypass", "cabg", "attack"]):
        return (
            "Patient requires special cardiac care and monitoring.",
            [
                "Monitor blood pressure and heart rate",
                "Ensure timely medication adherence",
                "Limit physical activity as needed",
                "Dietary and lifestyle care",
                "Regular doctor follow-ups"
            ]
        )

    # Elderly / chronic / bedridden
    if any(k in s for k in ["elderly", "old", "bedridden", "diabetes", "ckd", "weak"]):
        return (
            "Patient requires long-term or age-based daily assistance.",
            [
                "Complete daily activity assistance",
...
def generate_marathi_explanation_and_plan(symptom):
    s = symptom.lower()

    # Wound care / dressing
    if "dressing" in s or "wound" in s:
        return (
            "रुग्णास जखम/ड्रेसिंग संबंधित नियमित काळजी आणि निरीक्षणाची आवश्यकता आहे.",
            [
                "जखमेची स्वच्छता आणि ड्रेसिंग बदल",
                "संसर्गाचे निरीक्षण",
                "वेदनांचे व्यवस्थापन"
            ]
        )

    # Joint pain / replacement / orthopedic surgeries
    elif any(k in s for k in ["knee replacement", "hip replacement", "tkr", "joint pain", "hip ball", "femur fracture"]):
        return (
            "रुग्णास हालचालीसाठी फिजिओथेरपी आणि पोस्ट-सर्जरी सहाय्य आवश्यक आहे.",
            [
                "फिजिओथेरपी आणि व्यायाम",
                "चलण्यास सहाय्य (वॉकिंग सपोर्ट)",
                "वेदनांचे व्यवस्थापन आणि निरीक्षण"
            ]
        )

    # Neuro-related issues
    elif any(k in s for k in ["stroke", "parkinson", "dementia", "neuro"]):
        return (
            "रुग्णास मज्जासंस्था संबंधित काळजी आणि दैनंदिन सहाय्याची आवश्यकता आहे.",
            [
                "चलण्याचे प्रशिक्षण आणि सहाय्य",
                "संज्ञानात्मक सहाय्य आणि निरीक्षण",
                "दैनंदिन क्रियाकलापासाठी देखभाल"
            ]
        )

    # Cancer / oncology
    elif "cancer" in s or "ca " in s:
        return (
            "रुग्णास कॅन्सर संबंधित आणि पोस्ट-सर्जरी काळजी आवश्यक आहे.",
            [
                "औषधोपचार आणि पोस्ट-सर्जरी निरीक्षण",
                "पोषण सहाय्य",
                "वेदनांवरील लक्ष आणि लक्षण व्यवस्थापन"
            ]
        )

    # General care / infection monitoring
    elif any(k in s for k in ["cold", "fever", "infection"]):
        return (
            "रुग्णास सामान्य आरोग्य निरीक्षण आवश्यक आहे.",
            [
                "जीवनचिन्हांचे निरीक्षण",
                "पाणी व आहाराची काळजी",
                "स्थिती बिघडल्यास डॉक्टरांचा सल्ला"
            ]
        )

    # Fallback / general
    return (
        "रुग्णास सामान्य आरोग्य सहाय्य आवश्यक आहे.",
        [
            "दैनंदिन क्रियाकलापासाठी सहाय्य",
            "जीवनचिन्हांचे निरीक्षण",
...
def hybrid_predict(symptom_input, gender_input):
    ...
    mr_explanation, mr_plan = generate_marathi_explanation_and_plan(symptom)

    print("\nस्पष्टीकरण:")
    print(mr_explanation)
